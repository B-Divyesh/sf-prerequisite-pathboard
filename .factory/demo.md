...
- URL: `https://prerequisite-pathboard.sociobot.in/demo` (local: `http://localhost:5173/demo`).
- Sample: a 14-concept route for explaining derivatives, with 14 user-authored prerequisite links and five completed repairs.
...
- Namespace: demo state is held only in page memory. It never opens or writes the real IndexedDB database named `prerequisite-pathboard`.
